          ...
          <form className="mx-auto mt-2">
            ...
            <div className="mx-auto my-3">
              ...
              <textarea
                required
                type="text"
                className=" text-white w-full p-4 mt-2 bg-black outline-none text-white border-form"
            ...
            <div className="mx-auto my-3">
              ...
              <input
                type="email"
                className=" text-white w-full p-4 mt-2 bg-black outline-none border-form"
            ...
            <div className="mx-auto my-3">
              ...
              <input
                list="browserss"
                className="w-full text-white p-4 mt-2 bg-black outline-none border-form"
