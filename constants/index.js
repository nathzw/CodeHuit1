...
export const startingFeatures = [
  'impulso inicial (Prosesos, herramientas, Equipo de trabajo)',
  'Fase inicial (Trello, Cronologia, Mapa de navegación)',
  'Implementación (Diseño UX/UI, Desarrollo, Control de calidad)',
];
